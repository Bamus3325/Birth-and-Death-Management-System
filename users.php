          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Registered Births</h3>
                <a href="register_user" class="btn btn-success float-right">Add new record</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <?php
              if (isset($_POST['fetch'])) {
                ...
                // code...
                $sql = $con->prepare("SELECT * FROM biodata WHERE reg_date >= :strt AND reg_date <= :stp WHERE status = 1 ORDER BY reg_date DESC");
                $sql->bindParam(":strt", $strt, PDO::PARAM_STR);
                $sql->bindParam(":stp", $stp, PDO::PARAM_STR);
              }
              else {
                  $sql = $con->prepare("SELECT * FROM biodata WHERE status = 1 ORDER BY reg_date DESC");
              }
              $sql->execute();
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="edit_user?biodata=<?= $user ?? ''; ?>" class="badge badge-primary"><i class="fas fa-edit"></i> Edit </a>
